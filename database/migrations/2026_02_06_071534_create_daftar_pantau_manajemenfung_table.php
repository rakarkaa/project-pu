...
return new class extends Migration
{
    ...
    {
 Schema::create('daftar_pantau_manajemenfung', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('perihal_manajemen')->nullable(); // opsional
    ...
    {
        Schema::dropIfExists('daftar_pantau_manajemenfung');
    }
};

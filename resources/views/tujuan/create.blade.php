...
<div class="d-flex justify-content-between align-items-center mt-4 mb-3">
    <h1 class="h3 mb-0 text-gray-800">Tambah Tujuan Surat</h1>
...
<div class="card shadow-sm border-0 border-top border-primary border-4 mb-4">
    <div class="card-header bg-white py-3">
        <h6 class="m-0 fw-bold text-primary"><i class="fas fa-plus-circle me-1"></i> Form Tambah Data</h6>
    </div>
    <div class="card-body p-4">
        ...
        <form action="{{ route('tujuan-surat.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Nama Unit Organisasi <span class="text-danger">*</span></label>
                    <input type="text" name="nama_unitorganisasi" class="form-control" placeholder="Contoh: BPSDM" required>
                </div>
                
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Nama Unit Kerja <span class="text-danger">*</span></label>
                    <input type="text" name="nama_unitkerja" class="form-control" placeholder="Contoh: Sekretariat BPSDM" required>
                </div>
            </div>

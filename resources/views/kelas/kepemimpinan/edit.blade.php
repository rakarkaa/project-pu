...
@section('content')
<div class="mt-4 mb-4">
    <h1 class="h3 mb-0 text-gray-800 fw-bold">Edit Kelas Kepemimpinan</h1>
    <p class="text-muted mt-1">Perbarui data kelas dan jadwal pelaksanaan.</p>
</div>

{{-- PENANGKAP PESAN ERROR: Agar jika ada yang salah, notifikasinya muncul --}}
@if ($errors->any())
...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3 border-bottom">
        <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-edit me-2"></i>Form Edit Kelas</h6>
    </div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('kelas.kepemimpinan.update', $kelas->id) }}" method="POST">
            ...
            {{-- PERBAIKAN: Input text diubah menjadi dropdown Select balai_id --}}
            <div class="mb-4">
            ...
            <div class="d-flex">
                ...
                <a href="{{ route('kelas.kepemimpinan.index') }}" class="btn btn-secondary rounded-pill px-4 shadow-sm ms-2">

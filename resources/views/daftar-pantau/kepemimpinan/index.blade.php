...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
        ...
        {{-- AREA FILTER (TAHUN & ANGKATAN) DENGAN WARNA PRIMARY --}}
        <div class="d-flex align-items-center gap-3">
            {{-- Filter Tahun --}}
            <div class="d-flex align-items-center">
                <label for="filterTahun" class="me-2 mb-0 fw-bold text-muted small"><i class="fas fa-calendar me-1"></i>Tahun:</label>
                <select id="filterTahun" class="form-select form-select-sm shadow-sm border-primary text-primary fw-bold" style="width: 130px; border-radius: 8px;">
            ...
            <div class="d-flex align-items-center">
                ...
                <select id="filterAngkatan" class="form-select form-select-sm shadow-sm border-primary text-primary fw-bold" style="width: 150px; border-radius: 8px;">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="tablePantauKepemimpinan" class="table table-bordered table-hover align-middle w-100">
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('daftar-pantau.kepemimpinan.show', $item->id) }}"
                                   class="btn btn-sm btn-primary rounded-pill px-3 shadow-sm transition-hover">

...
<div class="d-flex justify-content-between align-items-center mt-4 mb-3">
    <h1 class="h3 mb-0 text-gray-800">Edit Data Pemantauan Fungsional</h1>
    <a href="{{ route('daftar-pantau.fungsional.show', $item->kelas_fungsional_id) }}" class="btn btn-secondary btn-sm shadow-sm">
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="card-body">
        ...
        {{-- ACTION KE ROUTE UPDATE FUNGSIONAL --}}
        <form method="POST" action="{{ route('pantau.fungsional.kepesertaan.update', $item->id) }}" enctype="multipart/form-data">
            ...
            <hr class="mt-4">
            <div class="text-end">
                <a href="{{ route('daftar-pantau.fungsional.show', $item->kelas_fungsional_id) }}" class="btn btn-light border me-2">Batal</a>
